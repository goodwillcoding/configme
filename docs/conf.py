...
# sphinx-quickstart on Wed Dec 12 08:02:40 2012.
#
...
project = PACKAGE_NAME_PRETTY
copyright = u'2012, %s' % PACKAGE_AUTHOR
...
release = "%s%s" % (PACKAGE_VERSION, PACKAGE_VERSION_TAG)
...
htmlhelp_basename = '%sdoc' % str(PACKAGE_NAME_PRETTY)
...
latex_documents = [
    ('index',
     '%s.tex' % str(PACKAGE_NAME_PRETTY),
     u'%s Documentation' % PACKAGE_NAME_PRETTY,
     PACKAGE_AUTHOR,
     'manual'
    ),
    ]
